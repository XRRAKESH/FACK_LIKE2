...
DEVELOPERS = "@KIRITO_AX And @KIRITO_AE"
...
def api_documentation():
    return jsonify({
        ...
        "usage_guide": {
            "By using UID and Password": "/change-name?uid={uid}&password={password}&name={new_name}",
            "By using Access Token": "/change-name?access_token={access_token}&name={new_name}",
            "By using Direct JWT Token": "/change-name?jwt={jwt_token}&name={new_name}"
        }
    })
